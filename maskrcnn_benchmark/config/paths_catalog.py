...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        "cityscapes_train_cocostyle": {
            "img_dir": "/mnt/d/user1/dataset_da_2d/City_coco_style/leftImg8bit/train",
            "ann_file": "/mnt/d/user1/dataset_da_2d/City_coco_style/cocoAnnotations/cityscapes_train_cocostyle.json"
        },
        ...
        "cityscapes_foggy_train_cocostyle": {
            "img_dir": "/mnt/d/user1/dataset_da_2d/City_coco_style/leftImg8bit_foggy/train",
            "ann_file": "/mnt/d/user1/dataset_da_2d/City_coco_style/cocoAnnotations/cityscapes_foggy_train_cocostyle.json"
        },
        "cityscapes_val_cocostyle": {
            "img_dir": "/mnt/d/user1/dataset_da_2d/City_coco_style/leftImg8bit/val",
            "ann_file": "/mnt/d/user1/dataset_da_2d/City_coco_style/cocoAnnotations/cityscapes_val_cocostyle.json"
        },
        "cityscapes_foggy_val_cocostyle": {
            "img_dir": "/mnt/d/user1/dataset_da_2d/City_coco_style/leftImg8bit_foggy/val",
            "ann_file": "/mnt/d/user1/dataset_da_2d/City_coco_style/cocoAnnotations/cityscapes_foggy_val_cocostyle.json"
        },
        ...
        # },
        "voc_closed_2007_trainval": {
            "data_dir": "/mnt/d/user1/dataset_da_2d/VOCdevkit/VOC2007/",
            "split": "trainval"
        },
        "voc_closed_2012_trainval": {
            "data_dir":"/mnt/d/user1/dataset_da_2d/VOCdevkit/VOC2012/",
            "split": "trainval"
        },
        "water2voc_test": {
            "data_dir": "/mnt/d/user1/dataset_da_2d/VOCdevkit/VOC2007/",
        ...
        "clipart_voc_closed": {
            "data_dir": "/mnt/d/user1/dataset_da_2d/clipart/",
            "split": "all"
        },
        ...
        "water_train": {
            "data_dir": "/mnt/d/user1/dataset_da_2d/watercolor/",
            "split": "train"
        },
        "water_test": {
            "data_dir": "/mnt/d/user1/dataset_da_2d/watercolor/",
    ...
    def get(name):
        ...
        if "openset_voc" in name:
            data_dir = DatasetCatalog.DATA_DIR
            attrs = DatasetCatalog.DATASETS[name]
            split_ratio=name.split("_")[-1]
            args = dict(
                data_dir=os.path.join(data_dir, attrs["data_dir"]),
                split=attrs["split"],
                openset=split_ratio
            ...
            return dict(
                factory="Openset_Clipart",
                args=args,
            )
        
        elif "clipart_test" in name:
            data_dir = DatasetCatalog.DATA_DIR
            attrs = DatasetCatalog.DATASETS[name]
            split_ratio=name.split("_")[-1]
            args = dict(
            ...
            return dict(
                factory="Openset_Clipart_test",
                args=args,
            )
        
        elif "water2voc_test" in name:
            ...
            if "train" in name:
                ...
                return dict(
                    factory="WaterColorDataset_test",
                    args=args,
                )
        elif "voc_closed" in name:
            data_dir = DatasetCatalog.DATA_DIR
            attrs = DatasetCatalog.DATASETS[name]
            args = dict(
                data_dir=os.path.join(data_dir, attrs["data_dir"]),
