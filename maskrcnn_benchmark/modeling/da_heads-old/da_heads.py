    ...
    def __init__(self, in_channels):
        ...
        for idx in range(5):
            ...
            for module in [conv1_block_module, conv2_block_module]:
                ...
                torch.nn.init.normal_(module.weight, std=0.002*(idx+1))
    ...
    def __init__(self, in_channels):
        ...
        for idx in range(4):
            ...
            for module in [fc1_block_module, fc2_block_module, fc3_block_module]:
                # Caffe2 implementation uses XavierFill, which in fact
                # corresponds to kaiming_uniform_ in PyTorch
                nn.init.normal_(module.weight, std=0.003*(idx+1))
    ...
    def forward(self, proposals, img_features, da_ins_feature, da_ins_labels, da_proposals, targets=None):
        ...
        if self.training:
            da_img_loss, da_ins_loss = self.loss_evaluator(
                da_proposals, da_img_features, da_ins_features,da_ins_labels, targets, levels)
