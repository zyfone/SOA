...
class Water2voc_test(torch.utils.data.Dataset):
    ...
    def __init__(self, data_dir, split, use_difficult=False, transforms=None,is_source=True):
        ...
        print("\n")
        print("##################################################")
        print("Dataset TEST Part-set_WATER2VOC:",len(self.ids))
        print("test_CLASSES:",Water2voc_test.CLASSES)
        print("Source_CLASSES:",Water2voc_test.CLASSES)
        print("\n")
    ...
    def map_class_id_to_class_name(self, class_id):
        return Water2voc_test.CLASSES[class_id]
